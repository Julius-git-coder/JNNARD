                    ...
                    <form onSubmit={handleSubmit} className="space-y-6 mt-8">
                        ...
                        <div className="flex items-center justify-between">
                            <div className="flex items-center space-x-2">
                                ...
                                />
                                <label htmlFor="remember" className="text-sm font-medium leading-none text-gray-700 dark:text-gray-300">Remember me</label>
                            </div>
                            <Link href="/forgot-password" className="text-sm font-medium text-gray-900 hover:underline dark:text-gray-50">
                                Forgot Password?
                            </Link>
                        </div>
                        ...
                        <div className="text-center text-sm text-gray-500 dark:text-gray-400">
                            ...
                            <Link href="/signup" className="font-semibold text-gray-900 hover:underline dark:text-gray-50">
                                Sign up for free
                            </Link>
                        </div>
                    </form>
